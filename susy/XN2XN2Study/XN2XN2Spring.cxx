...
//
  ...
  Xhinit("h13",  0.0, qmx, 50,"E_tau- X0i           ");
  Xhinit("h14",  0.0, qmx, 50,"E_tau+               ");
  Xhinit("h15",  0.0, qmx, 50,"E_tau- X0j           ");
  Xhinit("h16",  0.0, qmx, 50,"E_tau+               ");
  Xhinit("h17", -1.0, 1.0, 50,"cos(theta_tau-) X0i  ");
  Xhinit("h18", -1.0, 1.0, 50,"cos(theta_tau+)      ");
  Xhinit("h19", -1.0, 1.0, 50,"cos(theta_tau-) X0j  ");
  Xhinit("h20", -1.0, 1.0, 50,"cos(theta_tau+)      ");
