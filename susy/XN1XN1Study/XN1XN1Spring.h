#ifndef XN1XN1SPRING_H
#define XN1XN1SPRING_H
...
// =====================================================================
//  COMMONs for XN1XN1 calculation, see USRPRM.inc for more details.
// =====================================================================
typedef struct {
  Float_t  sqrts;
  Float_t  polebm;
...
class XN1XN1Bases  : public JSFBases {
protected:
  ...
  Int_t    fX1ModesLo;  	// 1st Z1 decay mode ID.
  Int_t    fX1ModesHi;  	// lst Z1 decay mode ID.
  Int_t    fX2ModesLo;  	// 1st Z2 decay mode ID.
  Int_t    fX2ModesHi;  	// lst Z2 decay mode ID.
...
public:
  XN1XN1Bases(const char *name="XN1XN1Bases", 
	     const char *title="XN1XN1bar  Bases");
  virtual ~XN1XN1Bases(){} 
  ...
  void SetX1ModesLo(Int_t i){ fX1ModesLo=i; }
  Int_t GetX1ModesLo(){ return fX1ModesLo;}

  void SetX1ModesHi(Int_t i){ fX1ModesHi=i; }
  Int_t GetX1ModesHi(){ return fX1ModesHi;}

  void SetX2ModesLo(Int_t i){ fX2ModesLo=i; }
  Int_t GetX2ModesLo(){ return fX2ModesLo;}

  void SetX2ModesHi(Int_t i){ fX2ModesHi=i; }
  Int_t GetX2ModesHi(){ return fX2ModesHi;}
  ...
  ClassDef(XN1XN1Bases,1)  // Bases for e+e- -> XN1XN1bar process

};

class XN1XN1Spring;

class XN1XN1SpringBuf : public JSFSpringBuf {
public:
//  <<+XN1XN1bar>>
   Double_t fX[2];  // Two bases parameters, costh and phi.
//  <<-XN1XN1bar>>
public:
  XN1XN1SpringBuf(const char *name="XN1XN1SpringBuf", 
	     const char *title="XN1XN1Spring test event buffer",
	     XN1XN1Spring *spring=NULL)
	     : JSFSpringBuf(name,title,(JSFSpring*)spring) {} 
  virtual ~XN1XN1SpringBuf(){}
  virtual void Spevnt(Int_t &iret);

  ClassDef(XN1XN1SpringBuf,1)  // XN1XN1Spring event buffer
};

class XN1XN1Spring : public JSFSpring {
public:
   XN1XN1Spring(const char *name="XN1XN1Spring", 
	      const char *title="XN1XN1Spring test",
             XN1XN1Bases *bases=NULL);
   virtual ~XN1XN1Spring();

   virtual Bool_t Initialize(); // 

   ClassDef(XN1XN1Spring,1)  // XN1XN1Spring class
};
