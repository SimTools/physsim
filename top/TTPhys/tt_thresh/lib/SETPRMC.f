...
C>>>
      ...
      END IF
C--
C  QCD radiative correction to Gamma_t.
C--
C>>>
C     PRINT *, 'This version inculdes O(alpha_s) correction to ',
C    .         'top quark width.'
C>>>
      CF     = 4.D0/3
      RADCOR = 1 - CF*ALFST/2/PI * H(W**2)
C--
      GAMMA0 = VTB**2*GF/SQRT(2.D0) * AMT**3/4/PI * C1 * RADCOR
      ZMU    = AMT/( 1 + ZI*CAPPA*RADCOR )
C--
