...
C*                           This version draws m_t-alpha_s contours.
C*
      IMPLICIT  REAL*8 ( A-H, O-Y )
      PARAMETER   ( MXxAM = 80, MXxLM = 12, MXxCNT = 3 )
CX    REAL*8       RDATA(3,0:MXxLM,0:MXxAM), CHICNT(MXxCNT)
...
C--
      DATA AMTMN / 169.D0 / AMTMX / 171.D0 /
      DATA ALFMN / 0.10D0 / ALFMX / 0.136D0 /
      DATA (EXPCND(1,I),I=1,MXxRS) /  -7.D0, -6.D0, -5.D0,
     .                                -4.D0, -3.D0, -2.D0,
     .                                -1.D0,  0.D0,  1.D0,
     .                                 2.D0,  3.D0/
C     PARAMETER   ( MXxRS = 15 )
C     REAL*8       EXPCND(4,MXxRS)
C     DATA (EXPCND(1,I),I=1,MXxRS) /  -7.D0, -6.D0, -5.D0,
C    .                                -4.D0, -3.D0, -2.D0,
C    .                                -1.D0,  0.D0,  1.D0,
C    .                                 2.D0,  3.D0,  4.D0,
C    .                                 8.D0, 12.D0, 16.D0/
...
C--
C     CALL UALCPS(LOU,'TKSF.@.@MTALFS@.CONT.TDR','RENEW','FB',30,IRT)
C--
...
C>>>
CX          RDATA(1,ILM,IAM) = AMT
CX          RDATA(2,ILM,IAM) = ALFS
CX          RDATA(3,ILM,IAM) = CHI2
            RDATA(1,IAM,ILM) = ALFS
            RDATA(2,IAM,ILM) = AMT
            RDATA(3,IAM,ILM) = CHI2
C>>>
            WRITE(LOU,'(''(  '',3F15.6)')  AMT, ALFS, CHI2
C>>>
C           PRINT *, ' AMT, VTB2, CHI2 = ', AMT, ALFS, CHI2
C>>>
...
C>>>
C     PARAMETER    ( MXxRS = 30, MXxAM = 20, MXxAL = 10 )
      PARAMETER    ( MXxRS = 10, MXxAM = 80, MXxAL = 12 )
C>>>
...
C--
     ...
     .        ABS(ALFS-ALFSD).GT.1.D-4 ) THEN
            PRINT *, ' ALFS = ', ALFS, ' ALFSD = ', ALFSD
