...
C*   94/08/03  K.Fujii       E1S is determined only once for a
C*                           standard VTB2 given by VTBSTD.
C*                           In this version, E1S is thus independent
C*                           of VTB2 changes thus it is on VTBSTD.
C*
...
C  VTBSTD is VTB2 to decide 1S peak position.
C--
C>>>
      REAL     *8   VTBSTD
      REAL     *8   E1S
