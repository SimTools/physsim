...
typedef struct {
  ...
  Int_t    isrb;
  Int_t    imdzlo;	// Z- decay mode ID.
  Int_t    imdzhi;	// Z- decay mode ID.
...
protected:
  ...
  Int_t    fZModesLo;	// Z- decay mode ID.
  Int_t    fZModesHi;	// Z- decay mode ID.
...
public:
   ...
   ClassDef(TTZSpring,2)  // TTZSpring class
};
