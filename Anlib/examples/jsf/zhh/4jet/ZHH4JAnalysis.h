#ifndef ZHH4JANALYSIS_H
#define ZHH4JANALYSIS_H
//*************************************************************************
//* ========================
...
//
//
class ZHH4JAnalysis : public JSFModule {
public:
  ZHH4JAnalysis() : JSFModule("ZHH4JAnalysis", "ZHH4JAnalysis") {}
  ZHH4JAnalysis(const Char_t *name, const Char_t *title);
  virtual ~ZHH4JAnalysis();
...
private:
  ...
  ClassDef(ZHH4JAnalysis, 1) // ZHH4JAnalysis Example
};
