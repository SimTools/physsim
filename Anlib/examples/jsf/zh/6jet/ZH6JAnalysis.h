#ifndef ZH6JANALYSIS_H
#define ZH6JANALYSIS_H
//*************************************************************************
//* ========================
...
//
//
class ZH6JAnalysis : public JSFModule {
public:
  ZH6JAnalysis() : JSFModule("ZH6JAnalysis", "ZH6JAnalysis") {}
  ZH6JAnalysis(const Char_t *name, const Char_t *title);
  virtual ~ZH6JAnalysis();
...
private:
  ...
  ClassDef(ZH6JAnalysis, 1) // ZH6JAnalysis Example
};
