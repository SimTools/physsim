//*************************************************************************
//* ========================
//*  WHWH4JAnalysis Classes
//* ========================
//*
//* (Description)
//*   A sample user analysis classes for JLC analyses.
//*   This reads and analyze MC WH+WH- pair data. 
//* (Requires)
//* 	library Anlib
//* 	library WHWHStudy
//* (Provides)
//* 	class WHWH4JAnalysis
//* 	class WHWH4JAnalysisBuf
//* (Usage)
...
//  --------------------
//  WHWH4JAnalysis Class
//  --------------------
//
//

ClassImp(WHWH4JAnalysis)

WHWH4JAnalysis::WHWH4JAnalysis(const Char_t *name, const Char_t *title)
...
//_____________________________________________________________________
WHWH4JAnalysis::~WHWH4JAnalysis()
{
}

//_____________________________________________________________________
Bool_t WHWH4JAnalysis::Initialize()
{
  //--
  ...
  WHWHBases *bsp = static_cast<WHWHBases *>(gROOT->FindObject("WHWHBases"));
...
Bool_t WHWH4JAnalysis::Process(Int_t ev)
{
  //--
...
//_________________________________________________________
Bool_t WHWH4JAnalysis::Terminate()
{
