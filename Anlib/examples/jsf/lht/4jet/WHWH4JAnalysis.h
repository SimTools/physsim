...
//
//
class WHWH4JAnalysis : public JSFModule {
public:
  WHWH4JAnalysis() : JSFModule("WHWH4JAnalysis", "WHWH4JAnalysis") {}
  WHWH4JAnalysis(const Char_t *name, const Char_t *title);
  virtual ~WHWH4JAnalysis();
...
private:
  ...
  ClassDef(WHWH4JAnalysis, 1) // WHWH4JAnalysis Example
};
