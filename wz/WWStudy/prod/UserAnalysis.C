...
//*   This reads and analyze MC WW data (4-jet analysis).
//* (Requires)
//* 	library Anlib
//* 	library WWStudy
//* (Usage)
...
//*   1999/08/05  K.Fujii	Now finds jets and does 4-jet analysis. 
//*
//*************************************************************************
//
#include <iostream.h>
...
Double_t xEvis     = 100.00;	// Minimum visible energy
Double_t xPt       =  20.00;	// Pt maximum
Double_t xPl       =  40.00;	// Pl maximum
...
Double_t xCosw     =   1.00;	// |cos(theta_w)| maximum
Double_t xM2j      =  12.00;	// |m_jj-m_W| maximum
Double_t xAcop     = 180.00;	// Acoplanarity maximum
