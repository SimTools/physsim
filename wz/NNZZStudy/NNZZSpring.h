#ifndef __NNZZSpring__
#define __NNZZSpring__
...
// =====================================================================
//  COMMONs for NNZZ calculation, see USRPRM.inc for more details.
// =====================================================================
typedef struct {
...
public:
  NNZZBases(const char *name="NNZZBases", 
	     const char *title="NNZZbar  Bases");
  virtual ~NNZZBases(){} 
  ...
  ClassDef(NNZZBases,1)  // Bases for e+e- -> NNZZ process
...
public:
  NNZZSpringBuf(const char *name="NNZZSpringBuf", 
	     const char *title="NNZZSpring test event buffer",
	     NNZZSpring *spring=NULL)
...
public:
   NNZZSpring(const char *name="NNZZSpring", 
	      const char *title="NNZZSpring test",
             NNZZBases *bases=NULL);
   virtual ~NNZZSpring();
